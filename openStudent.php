	...
	<BODY class="black">
			...
			<DIV class="bar-block">
				<TABLE style="margin-left:10px" border="0" width="100%">
					...
					<TR>
						...
						<TD>
							<A href="fees.php" class="bar-item button padding" ><b>&nbsp; Leave Application</b></A>
						</TD>
					</TR>
					<TR>
						<TD>
						...
						<TD>
							<A href="academics.php" class="bar-item button padding" ><b>&nbsp; Assignments</b></A>
						</TD>
					</TR>
					<TR>
						<TD>
		...
		<DIV class="main" style="margin-left:300px;margin-top:43px;">
			...
			<HEADER class="container" style="padding-top:22px">
				<H5><b>Enter Marks and Subject ID</b></H5>
			</HEADER>
			<div class="container">
		        ...
		        <TR>
		          ...
		          <TH> Marks </TH>
					...
					<?php
						...
						$sql = "SELECT * FROM grades WHERE sid=".$rollNum.";";
						$result = mysqli_query($con,$sql);
						foreach($result as $row){
							$count = $count + 1;
							$sub = $row['subid'];
							$mar = $row['marx'];
		          echo "<TR><TD>".$sub."</TD><TD><INPUT type=\"number\" name=\"subject".$count."\">".$mar."</INPUT></TD></TR>";
		        }
					?>
		    </TABLE>
				<INPUT type="submit"/>
