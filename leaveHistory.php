...
<?php
$eid=$_SESSION['eid'];
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblleaves where empid=:fid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$fid,PDO::PARAM_STR);
$query->execute();
