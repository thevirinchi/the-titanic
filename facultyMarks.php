	...
	<BODY class="black">
			...
			<DIV class="bar-block">
				<TABLE style="margin-left:10px" border="0" width="100%">
					<TR>
						...
						<TD>
							<A href="slider.html" class="bar-item button padding"><b>&nbsp; Leave Application</b></A>
						</TD>
					</TR>
					<TR>
						<TD>
		...
		<DIV class="main" style="margin-left:300px;margin-top:43px;">
			...
			<HEADER class="container" style="padding-top:22px">
				<H5><b>Select a student</b></H5>
			</HEADER>

			<DIV class="container">
				<FORM method="POST" action="openStudent.php">
					<INPUT type="number" name="rollNum" id="rollNum" placeholder="Roll Number" style="min-width:10%"/><BR><BR>
					<INPUT type="text" name="subId" id="subId" placeholder="Subject ID" style="min-width:11.5%"/><BR><BR>
					<INPUT type="number" name="asId" id="asId" placeholder="Assignment ID" style="min-width:10%"/><BR><BR>
					<INPUT type="number" name="marks" id="marks" placeholder="Marks" style="min-width:10%"/><BR><BR>
					<INPUT type="submit" value="Submit Makrs" id="submit" name="submit"/>
				</FORM>
			</DIV>
